...
@register_command(
    "vectorization textembeddingprofile list",
)
class List(AAZCommand):
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.TextembeddingprofilesList(ctx=self.ctx)()
    ...
    class TextembeddingprofilesList(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/instances/{instanceId}/providers/FoundationaLLM.Vectorization/textembeddingprofiles",
                **self.url_parameters
            )
